...
@Component({
  selector: 'app-record-principal',
  templateUrl: './record-principal.component.html',
  styleUrls: ['./record-principal.component.scss']
})
export class RecordPrincipalComponent implements OnInit {
